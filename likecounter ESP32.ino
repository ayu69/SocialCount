...
void loop() {
  ...
  facebook();
  Wire.write(FBLike_Brut >> 8);  /* sends hello string */
  Wire.write(FBLike_Brut & 255);
  
  twitter();
  Wire.write(TWLike_Brut >> 8);  /* sends hello string */
  Wire.write(TWLike_Brut & 255);
  
  instagram();
  Wire.write(INLike_Brut >> 8);  /* sends hello string */
  Wire.write(INLike_Brut & 255);
