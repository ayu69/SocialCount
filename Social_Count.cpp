...
*/
Adafruit_NeoPixel strip = Adafruit_NeoPixel(153, 6, NEO_GRB + NEO_KHZ800);
...
void loop() {
  ...
  writeDigit(0, FB_centaines_milliers);
  facebooklogo();
  strip.show();
  delay(7000);
  rainbow(4);
  ...
  writeDigit(0, TW_centaines_milliers);
  strip.show();
  delay(7000);
  rainbow(4);
  ...
  writeDigit(0, IN_centaines_milliers);
  strip.show();
  delay(7000);
  rainbow(4);
...
////////////////////////////////////////////////////////////////////////////
    ...
    FB_centaines_milliers = FBLike_Brut / 100000 % 10;
    ...
    Serial.println(FB_centaines_milliers);
    */
////////////////////////////////////////////////////////////////////////////
    ...
    TW_centaines_milliers = TWLike_Brut / 100000 % 10;
    ...
    Serial.println(TW_centaines_milliers);
    */
//////////////////////////////////////////////////////////////////////////
    ...
    IN_centaines_milliers = INLike_Brut / 100000 % 10;
    ...
    Serial.println(IN_centaines_milliers);
    */
...
void facebooklogo(){
 for (int i = 126; i < 135; i++) {
  strip.setPixelColor(i, strip.Color(59, 89, 152));
 }  
}
